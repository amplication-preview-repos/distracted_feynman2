...
@InputType()
class DonationCreateNestedManyWithoutBloodRequestsInput {
...
export { DonationCreateNestedManyWithoutBloodRequestsInput as DonationCreateNestedManyWithoutBloodRequestsInput };
